void Show_Clock()
{
  ...
  else
  {
    ...
    if (Clock_hour == nowTime.hour && Clock_min == nowTime.minute)
    {
    ...
    if ((Change_Clock_Settings == 1) && Set_Clock_Yes)
    {
      tft.pushImage(0, 0, 240, 240, clock_Img);
      ////////////////////////////////////
      date_set = nowTime.day;
      month_set = nowTime.month;
      year_set = nowTime.year;
      hour_set = Clock_hour;
      min_set = Clock_min;
      weekday_set = nowTime.weekday;
      datetime_lock = true;
      delay(10);
      ///////////////////////////////////
      tft.setCursor(30, 30);
