...
*/
//Link:- https://mightyohm.com/blog/2008/09/arduino-based-avr-high-voltage-programmer/comment-page-3/

// Desired fuse configuration
//For ATMega8
#define  LFUSE  0xA4   // http://www.engbedded.com/cgi-bin/fc.cgi
#define  HFUSE  0xCD   // Default for ATmega48/88/168, for others see
